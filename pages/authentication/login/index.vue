<template>
  <b-card>
    ...
    <b-card-body>
      <b-container>
        <b-row class="justify-content-md-center" align-v="center" align-h="between">
          <b-col md="3">
            <b-card>
          ...
          <b-col md="6">
            <b-container fluid>
              <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="453.78" height="326"
                   viewBox="0 0 853.78 726" xmlns:xlink="http://www.w3.org/1999/xlink"><title>treasure</title>
                ...
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="#3f3d56"/>
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="#f1f1f1"/>
                <path
                ...
                <polygon
                  ...
                  opacity="0.1"/>
                <polyline points="731.21 602.65 692.45 620.88 501.94 545.52 501 549.28 691.68 623.56 730.63 604.44"
                          opacity="0.1"/>
                <ellipse cx="691.21" cy="619.15" rx="6.67" ry="7.2" transform="translate(-278.2 1008.63) rotate(-72.75)"
                         fill="#3f3d56"/>
                <ellipse cx="859.13" cy="684.17" rx="6.67" ry="7.2" transform="translate(-222.18 1214.73) rotate(-72.75)"
                         fill="#3f3d56"/>
                <ellipse cx="832.58" cy="764.93" rx="6.67" ry="7.2" transform="translate(-317.97 1246.17) rotate(-72.75)"
                         fill="#3f3d56"/>
                <ellipse cx="670.66" cy="697.17" rx="6.67" ry="7.2" transform="translate(-367.16 1043.88) rotate(-72.75)"
                         fill="#3f3d56"/>
                <path
                  d="M707.22,598.38c-.4,1.3-3.61,0-7.69-1.28s-7.26-2.68-6.86-4,4.24-2,8.32-.73S707.63,597.08,707.22,598.38Z"
                  transform="translate(-173.11 -87)" fill="#3f3d56"/>
                <ellipse cx="721.08" cy="591.65" rx="2.46" ry="7.02" transform="translate(-230.92 1017.81) rotate(-72.75)"
                         fill="#3f3d56"/>
                <path d="M793.58,630c-.4,1.3-4.41.1-8.3-1.11s-6.92-2.56-6.52-3.86,4.09-2,8-.83S794,628.68,793.58,630Z"
                      transform="translate(-173.11 -87)" fill="#3f3d56"/>
                <path
                ...
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="#3f3d56"/>
                <ellipse cx="749.03" cy="590.77" rx="2.46" ry="6.06" transform="translate(-210.42 1043.88) rotate(-72.75)"
                         fill="#3f3d56"/>
                <path
                  ...
                  transform="translate(-173.11 -87)" opacity="0.1"/>
                <path
                ...
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="none" stroke="#3f3d56" stroke-miterlimit="10" stroke-width="4"/>
                <path
                  d="M1011.4,619.14a14,14,0,0,0-7-11.5l-3.14,6.22.1-7.53a14.19,14.19,0,0,0-4.63-.56,14,14,0,1,0,14.68,13.37Z"
                  transform="translate(-173.11 -87)" fill="#57b793"/>
                <path d="M986.37,714.13a14,14,0,1,1,.68-11.3L978.28,710l9.65-2.23A14,14,0,0,1,986.37,714.13Z"
                      transform="translate(-173.11 -87)" fill="#57b793"/>
                <path
                ...
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="#656380"/>
                <path
                  ...
                  transform="translate(-173.11 -87)" opacity="0.2"/>
                <path
                ...
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="#ffc0c6"/>
                <path
                  d="M379.93,294c-.11,3.24-2,6.12-3.82,8.81-2.43,3.58-5,7.3-8.84,9.3a84.94,84.94,0,0,0,62.78,6.62c3.37-1,7.35-3.08,7.15-6.59-4-1.09-8.14-2.22-11.54-4.63-4.06-2.88-6.74-7.36-8.47-12s-2.61-9.6-3.82-14.43a2.72,2.72,0,0,0-.62-1.34,2.76,2.76,0,0,0-1.9-.5L397.53,279c-5.47,0-11.41-.13-16.49,2.19C374.72,284.09,380.11,288.62,379.93,294Z"
                  transform="translate(-173.11 -87)" opacity="0.1"/>
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="#575a88"/>
                <path
                ...
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="#3c354c"/>
                ...
                <path
                  ...
                  transform="translate(-173.11 -87)" fill="#0cd8bb"/>
                <path
...
export default {
  ...
  methods: {
    async onSubmit(event) {
      ...
      const user = await processLoginForm(this, this.form.email, this.form.password);

      if(user) {
        await this.$router.push({path: "/item", query: {name: user.name}});
      }
    }
  }
}
